...
public class DatoAdministrador {
	...
	public DatoAdministrador(){
	}
	
	public DatoAdministrador(String n_cedula_admi, String id_cargo, String abr_estado, 
			String nombres, String apellidos, String fecha_nacimiento, String telefono, 
			String email, String tipo_sangre){
