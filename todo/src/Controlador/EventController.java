...
public class EventController extends GenericForwardComposer {
	...
	public void onClick$add() {
		TodoEvent newEvt = new TodoEvent(current.getN_cedula_tax(), current.getN_matricula(), current.getNombres(),
				current.getApellidos(), current.getLicencia(), current.getDireccion(), current.getTelefono(),
